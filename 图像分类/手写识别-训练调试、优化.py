...
def train(model):
    ...
    # 保存模型参数
    paddle.save(model.state_dict(), './model/mnist_acc.pdparams')
...
def evaluation(model):
    ...
    # 定义预测过程
    params_file_path = './model/mnist_mul_data.pdparams'
    # 加载模型参数
...
def train(model):
    ...
    # 保存模型参数
    paddle.save(model.state_dict(), './model/mnist_plot.pdparams')
...
def train(model):
    ...
    # 保存模型参数
    paddle.save(model.state_dict(), './model/mnist_visDL.pdparams')
