...
params_file_path = r'D:\PycharmProgram\paddle_train_model\文本情感分析\\sentiment_classifier.pdparams'
# 实例化模型
...
sentiment_classifier.load_dict(model_state_dict)

# 保存inference模型
from paddle.static import InputSpec
paddle.jit.save(
    layer=sentiment_classifier,
    path="D:\PycharmProgram\paddle_train_model\文本情感分析\\inference",
    input_spec=[InputSpec(shape=[1,128,256], dtype='float32')])